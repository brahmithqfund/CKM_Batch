...
public class LoginAdmin extends CKM_PDL{
    ...
    public static WebElement txtbx_UserName(WebDriver driver){
     ...
     public static void LoginAdmin(String username, String password, String storenumber) {
 		...
 		u.clear();
 		u.sendKeys(UserNameAdmin);
 		test.log(LogStatus.PASS, "Username is entered: " + UserNameAdmin);
